-- 1. 덧셈 연산자를 사용하여 모든 사원에 대해서 $300의 급여 인상을 계산한 후, 사원이름, 급여, 인상된 급여를 출력
...
select ename 사원이름, salary 급여, (salary * 12) + 100 + NVL(commission, 0) 연간총수입
from employee
order by ename desc, salary desc, (salary * 12) + 100 + NVL(commission, 0) desc;
