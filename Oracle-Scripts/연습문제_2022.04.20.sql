...
select ename 사원이름, substr(hiredate,1,5) 입사년월
from employee;
...
select ename 사원이름, nvl(manager, 0) 직속상관
from employee;
...
decode(trunc(manager/100), 75, '5555', 76, '6666', 77, '7777', 78, 8888, null, '0000', manager) "바뀐 직속상관 번호"
from employee;